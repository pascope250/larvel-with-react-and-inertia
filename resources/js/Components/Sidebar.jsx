      ...
      <div className="sidebar">
        ...
        <nav className="mt-2">
          <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li className={`nav-item ${Iscollapse && c == 1 ? 'menu-is-opening menu-open' : ''}` } onClick={ () => collapse(1)}>
            ...
            <li className={`nav-item ${Iscollapse && c == 2 ? 'menu-is-opening menu-open' : ''}` } onClick={() => collapse (2)}>
              <a href="#" className="nav-link">
